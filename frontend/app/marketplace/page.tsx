...
function ProductList({ products, onViewDetails }: ProductListProps & { onViewDetails: (product: Product) => void }) {
  return (
    <main className="p-8">
            ...
            <CardFooter className="flex justify-between gap-2 items-center flex-wrap">
              <div className="flex flex-col m-auto">
                ...
                <div className="flex flex-row justify-around gap-2">
                  <Button onClick={() => onViewDetails(product)} className="px-4 py-2 flex hover:bg-[#E0E0E0] hover:border-[#B3B3B3] text-[16px] !bg-[#F5F5F5] !text-black border border-[#D1D1D1]">
                    <Eye className="mr-2 h-4 w-4" />
                      More Details
                  </Button>
                  <Button className="text-[16px] !bg-[#F5F5F5] !text-black border border-[#D1D1D1] px-4 py-2 hover:bg-[#E0E0E0] hover:border-[#B3B3B3]">
                      <MessageSquareMore className="mr-2 h-4 w-4" /> Chat with Seller
                  </Button>
                </div>
              </div>
            </CardFooter>
